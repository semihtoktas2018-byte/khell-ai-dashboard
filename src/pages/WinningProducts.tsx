...
export default function WinningProducts() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showFilters && (
        <div className="card-glow rounded-xl p-5 grid grid-cols-1 sm:grid-cols-3 gap-4 bg-card border border-border">
          <div>
          ...
          return (
            ...
            >
              ...
              <div className="mt-auto pt-2 border-t border-border/60">
                ...
                {isExpanded && (
                  <div className="mt-3 space-y-2 bg-background/50 p-3 rounded-lg border border-border/40 text-[11px]">
