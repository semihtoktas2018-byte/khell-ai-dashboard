...
const T: Record<L, any> = {
  tr: {
    ...
    badge: "Dürüst rakamlarla ürün araştırma platformu",
    h1a: "Kazanan Ürünleri", h1b: "Rakamla Bul, Hızla Büyü!",
    sub: "Ürününü tahminle değil rakamla seç: kâr marjını, riskini ve 0–100 karar skorunu saniyeler içinde gör.",
    checks: ["Veri Destekli Analiz", "Rakip & Pazar Analizi", "Gerçek Zamanlı Veriler", "Tedarikçi Entegrasyonları", "Kâr & Risk Hesabı", "Adım Adım Strateji"],
    ...
    feats: [
      { t: "Ürün Analizi", d: "Ürünü gir; kâr, marj ve 0–100 karar skorunu anında dürüst rakamlarla gör." },
      ...
      { t: "İçerik & Reklam Araçları", d: "Ürün sayfası, reklam metni ve rakip reklam analizini tek panelden üret." },
    ...
    footTagline: "Dürüst rakamlarla ürün araştırma platformu. E-ticarette kazanan sen ol.",
  ...
  en: {
    ...
    badge: "Data-driven product research platform",
    h1a: "Find Winning Products", h1b: "by the Numbers, Scale Fast!",
    sub: "Choose products by numbers, not guesswork: see profit margin, risk and a 0–100 decision score in seconds.",
    checks: ["Data-Driven Analysis", "Competitor & Market Analysis", "Real-Time Data", "Supplier Integrations", "Profit & Risk Math", "Step-by-Step Strategy"],
    ...
    feats: [
      { t: "Product Analysis", d: "Enter a product; get honest profit, margin and a 0–100 decision score instantly." },
      ...
      { t: "Content & Ad Tools", d: "Generate product pages, ad copy and competitor ad analysis in one place." },
    ...
    footTagline: "Data-driven product research platform. Win in e-commerce.",
  ...
  fr: {
    ...
    checks: ["Analyse par les données", "Analyse Concurrence & Marché", "Données en Temps Réel", "Intégrations Fournisseurs", "Calcul Profit & Risque", "Stratégie Pas à Pas"],
